...
class QueueQos(object):
    ...
    def get_queue_id(self, portNo, maxRate, minRate):
        queuePort = self.queueInfo.get(portNo, QueuePort(portNo))
    ...
    def makeQueueRest(self, portName, maxRate, minRate, queueId, parentMaxRate=10000000):
        rest = {}
...
class QueueInfo(object):
    ...
    def __init__(self, id, maxRate, minRate, inUse=False):
